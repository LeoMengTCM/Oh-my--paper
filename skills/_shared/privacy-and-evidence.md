...
- Before finishing CCFA-family maintenance, run `_shared/scripts/check_path_privacy.py` at the repository root and remove any reported local path leaks.
...
- `inno-deep-research` must exclude MDPI sources from search, citation, scoring, and final outputs.
