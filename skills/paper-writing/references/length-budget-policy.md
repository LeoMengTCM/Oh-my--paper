...
Use the venue guide first. If the local guide lacks a clear page limit, infer a draft target from the venue family and label it `policy-stale`; route final compliance to `submission-checker`.
...
7. **Required disclosures:** add only venue-required or scientifically material scope, ethics, reproducibility, and impact content; route judgment-sensitive wording through `paper-humanization`.
