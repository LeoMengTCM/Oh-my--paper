...
> clinical / systematic-review track 额外创建冻结计划与偏离记录：`.pipeline/docs/protocol.md`、`.pipeline/docs/sap.md`、`.pipeline/memory/protocol_deviations.md`。锁定后不得随意改写，任何变更记入 deviations。
