...
This section centralizes the writing constraints that may also appear in `paper-writing` references. `paper-humanization` applies them as a sidecar preflight before publication-facing prose is drafted, revised, or finalized.
