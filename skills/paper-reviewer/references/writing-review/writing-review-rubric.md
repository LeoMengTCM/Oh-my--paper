...
Apply `../../../paper-writing/references/prose-quality-guardrails.md`. Flag these as writing risks even when the science is otherwise plausible:
...
- If the user asks for actual rewriting, follow CCFA handoff mode before using `paper-writing`.
