...
def make_card(meta):
    ...
    out.append('Source: distilled from PDF by paper-to-exemplar skill.')
...
def main():
    ...
    if args.set_default:
        ...
        print(' paper-writing/references/exemplars/cards/')
        print('2. Update index: paper-writing/references/exemplars/index.md')
        print('3. Set as default: paper-writing/references/custom-format/default-user-format.md')
    print()
