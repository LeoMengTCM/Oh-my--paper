...
> Venue reference material for `paper-writing` and `submission-checker`, not a standalone skill.
...
| Venue family | AI |
| CCF tier | CCF-A |
| Template path | `paper-writing/templates/CVPR/main.tex`, `paper-writing/templates/CVPR/preamble.tex`, `paper-writing/templates/CVPR/rebuttal.tex` |
...
- Use `paper-writing` for actual paper writing and polishing.
- Use `paper-reviewer` or `submission-checker` for format audit, depending on whether the task is manuscript-facing or submission-package-facing.
...
**Template:** `paper-writing/templates/CVPR/main.tex`, `CVPR/preamble.tex`, `CVPR/rebuttal.tex`
