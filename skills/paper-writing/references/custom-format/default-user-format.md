...
The custom exemplar list is intentionally easy to edit. To add or remove future examples, use `paper-to-exemplar`, which distills user-provided papers and updates the exemplar registry without treating source text as a reusable template.
