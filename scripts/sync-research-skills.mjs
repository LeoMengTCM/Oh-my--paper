...
const STAGE_FALLBACKS = {
  ...
  "paper-reviewer": ["publication"],
  "paper-humanization": ["publication"],
  "paper-to-exemplar": ["publication"],
  "rebuttal-writer": ["publication"],
  "submission-checker": ["publication"],
  "integrity-auditor": ["publication"],
